...
const en: Translations = {
  ...
  hero: {
    badge: 'B2B Operations & AI Strategy',
    line1: 'Operations.',
    line2: 'Optimised.',
    line3: 'Delivered.',
    body: 'We transform how B2B companies operate—from strategy to implementation. AI-powered workflows, custom tools, and execution that actually works.',
...
const sl: Translations = {
  ...
  hero: {
    badge: 'B2B Operacije & AI Strategija',
    line1: 'Operacije.',
    line2: 'Optimizirane.',
    line3: 'Dostavljene.',
    body: 'Preoblikujemo način delovanja B2B podjetij – od strategije do implementacije. Delovni tokovi z umetno inteligenco, orodja po meri in izvedba, ki dejansko deluje.',
...
const de: Translations = {
  ...
  hero: {
    badge: 'B2B Operations & KI-Strategie',
    line1: 'Abläufe.',
    line2: 'Optimiert.',
    line3: 'Geliefert.',
    body: 'Wir transformieren die Arbeitsweise von B2B-Unternehmen – von der Strategie bis zur Umsetzung. KI-gestützte Workflows, maßgeschneiderte Tools und Ausführung, die wirklich funktioniert.',
